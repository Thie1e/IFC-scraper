...
# Get the URLs of all projects of a database page -----------------------------
...
# Get the names of the tabs at the bottom of the page ---------------------
...
# On windows (my experience with Win 10) there are enconding problems which lead
# to characters like Â or â€™. Convert encoding from UTF-8 and also remove
...
# Get the relevant data from a project's page -----------------------------
...
#                 sapply(x, function(x) {
#                     pat <- paste0(x, "[ |$]")
#                     grep(enterpriseBase, pattern = pat)
#                 })
            })
